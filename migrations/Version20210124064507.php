 ...
 */
final class Version20210124064507 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE item (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, shop_id INT NOT NULL, name VARCHAR(255) NOT NULL, price VARCHAR(255) NOT NULL, ingredients VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, is_in_home_page TINYINT(1) NOT NULL, INDEX IDX_1F1B251E12469DE2 (category_id), INDEX IDX_1F1B251E4D16C4DD (shop_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE message (id INT AUTO_INCREMENT NOT NULL, sender_id INT NOT NULL, state_id INT DEFAULT NULL, reply_to_id INT DEFAULT NULL, message VARCHAR(5000) DEFAULT NULL, date DATETIME NOT NULL, is_reply_to TINYINT(1) NOT NULL, INDEX IDX_B6BD307FF624B39D (sender_id), INDEX IDX_B6BD307F5D83CC1 (state_id), INDEX IDX_B6BD307FFFDF7169 (reply_to_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE open_hour (id INT AUTO_INCREMENT NOT NULL, shop_id INT NOT NULL, start VARCHAR(10) NOT NULL, end VARCHAR(10) NOT NULL, day VARCHAR(20) NOT NULL, INDEX IDX_C9EA506B4D16C4DD (shop_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE open_hour ADD CONSTRAINT FK_C9EA506B4D16C4DD FOREIGN KEY (shop_id) REFERENCES coffee_shop (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE open_hour DROP FOREIGN KEY FK_C9EA506B4D16C4DD');
