...
!function ($) {
    ...
    AdvancedForm.prototype.init = function () {
        ...
        $collectionHolder1 = $('ul.item_images');
        ...
        // setup an "add a tag" link
        var $addTagButton2 = $('<button type="button" class="add_children_link btn btn-sm btn-primary">Add Product</button>');
        var $newLinkLi2 = $('<li><hr/></li>').append($addTagButton2);

        // Get the ul that holds the collection of tags
        $collectionHolder2 = $('ul.items');
        ...
        function addTagFormDeleteLink2($tagFormLi2) {
            var $removeFormButton2 = $('<button type="button" class="btn btn-sm btn-danger">Delete Product</button>');
