...
!function ($) {
    ...
    AdvancedForm.prototype.init = function () {
        ...
        var $addTagButton2 = $('<button type="button" class="add_children_link btn btn-sm btn-primary">Add</button>');
        var $newLinkLi2 = $('<li><hr/></li>').append($addTagButton2);

        // Get the ul that holds the collection of tags
        $collectionHolder2 = $('ul.contact_details');
        ...
        function addTagFormDeleteLink2($tagFormLi2) {
            var $removeFormButton2 = $('<button type="button" class="btn btn-sm btn-danger">Delete</button>');
